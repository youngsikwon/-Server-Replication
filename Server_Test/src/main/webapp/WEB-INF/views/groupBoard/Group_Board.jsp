                    ...
                    <thead>
                        ...
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                         ...
                         <th align="center" style="padding-left: 30px;"><spring:message code="part.E1" text="default text"></spring:message></th>
                          ...
                          <th align="center"style="padding-left: 30px;"><spring:message code="part.E8" text="default text"></spring:message></th>
                          <th align="center"style="padding-left: 30px;"><spring:message code="part.E9" text="default text"></spring:message></th>
                          <th align="center"style="padding-left: 30px;"><spring:message code="part.E10" text="default text"></spring:message></th>
                        </tr>
                      </thead>
                    <tbody>
                      <c:forEach var="row" items="${list}">
                        ...
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                          ...
                          <td align="center"><a href="${path}/groupBoard/Group_view?t_group_id=${row.t_group_id}">${row.t_group_owner}</a></td>
                        ...
                        <div>            
            <a onClick="location.href='${path}/groupBoard/Group_Insert/'" class="btn btn-primary">등록</a>
