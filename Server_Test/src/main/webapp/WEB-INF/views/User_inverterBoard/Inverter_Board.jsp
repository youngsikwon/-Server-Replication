                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                     <thead>
                        ...
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                          ...
                          <th align="center"><spring:message code="part.G8" text="default text"></spring:message></th>
                          <th align="center"><spring:message code="part.G1" text="default text"></spring:message></th>
                           <th align="center"><spring:message code="part.G2" text="default text"></spring:message></th>
                           <th align="center"><spring:message code="part.G3" text="default text"></spring:message></th>
                           <th align="center"><spring:message code="part.G4" text="default text"></spring:message></th>
                           <th align="center"><spring:message code="part.G5" text="default text"></spring:message></th>
                           <th align="center"><spring:message code="part.G6" text="default text"></spring:message></th>
                           <th align="center"><spring:message code="part.G7" text="default text"></spring:message></th>
                        </tr>
                      </thead>
              <tbody> 
                      <c:forEach var="row" items="${list}">
                        <tr bgcolor="#FFFFFF" onmouseover="this.style.backgroundColor='#E1FFFF'"
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                           <td><input type="checkbox" id="chBox" name="inverter_idx" value="${row.inverter_idx}" /></td>
                          <td align="center">${row.inverter_idx}</td>
                          <td align="center">${row.inverter_id}</td>
                          <td align="center">${row.inverter_name}</td>
                          <td align="center">${row.inverter_model}</td>
                          <td align="center">${row.inverter_capacity}</td>
                          <td align="center">${row.inverter_manager}</td>
...
$("#btnDelete").clik(function () {
	if(confirm("삭제를 하시겠습니까?")){
		document.form1.action="${path}/inverterBoard/delete";
