                     ...
                     <thead>
                        ...
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                          <td><input type="checkbox" id="checkall" /></td>
                  		   <th align="center"style="padding-left: 50px;"><spring:message code="part.F1" text="default text"></spring:message></th>
                  		   <th align="center"style="padding-left: 50px;"><spring:message code="part.F2" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.F3" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.F4" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.F5" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.F6" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.F7" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 70px;"><spring:message code="part.F8" text="default text"></spring:message></th>
                        </tr>
                      </thead>
              <tbody> 
                 <c:forEach var="row" items="${list}">
                        <tr bgcolor="#FFFFFF" onmouseover="this.style.backgroundColor='#E1FFFF'"
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                           <td><input type="checkbox" name="tracker_idx" value="${row.tracker_idx}" /></td>
                          ...
                          <td align="center"><a href="${path}/trackerBoard/Tracker_view?tracker_idx=${row.tracker_idx}">${row.tracker_name}</a></td>
                          ...
                          <td align="center"><a href="${path}/trackerBoard/Tracker_view?tracker_idx=${row.tracker_idx}">${row.tracker_manager}</a></td>
                        ...
                        <div>            
            <a onClick="location.href='${path}/trackerBoard/Tracker_Insert'" class="btn btn-primary">등록</a>
