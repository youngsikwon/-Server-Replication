                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                     <thead>
                        ...
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                          ...
                          <th align="center" style="padding-left: 50px;"><spring:message code="part.G8" text="default text"></spring:message></th>
                          <th align="center" style="padding-left: 50px;"><spring:message code="part.G1" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.G2" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.G3" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.G4" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.G5" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 50px;"><spring:message code="part.G6" text="default text"></spring:message></th>
                           <th align="center"style="padding-left: 80px;"><spring:message code="part.G7" text="default text"></spring:message></th>
                        </tr>
                      </thead>
              <tbody> 
                      <c:forEach var="row" items="${list}">
                        <tr bgcolor="#FFFFFF" onmouseover="this.style.backgroundColor='#E1FFFF'"
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                           <td><input type="checkbox" name="inverter_idx" value="${row.inverter_idx}" /></td>
                          ...
                          <td align="center"><a href="${path}/inverterBoard/Inverter_view?inverter_idx=${row.inverter_idx}">${row.inverter_name}</a></td>
                          ...
                          <td align="center"><a href="${path}/inverterBoard/Inverter_view?inverter_idx=${row.inverter_idx}">${row.inverter_manager}</a></td>
                      ...
                      <div>            
            <a onClick="location.href='${path}/inverterBoard/Inverter_insert'" class="btn btn-primary">등록</a>
