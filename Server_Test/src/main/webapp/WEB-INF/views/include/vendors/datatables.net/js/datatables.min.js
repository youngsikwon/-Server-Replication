 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/af-2.3.3/b-1.5.6/kt-2.5.0
 *
 * Included libraries:
 *   DataTables 1.10.18, AutoFill 2.3.3, Buttons 1.5.6, KeyTable 2.5.0
 */
...
(function(h) {
    ...
    n.ext = x = {
        buttons: {},
        classes: {},
        build: "bs4/dt-1.10.18/af-2.3.3/b-1.5.6/kt-2.5.0",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, g, h) {
...
$jscomp.polyfill = function(b, g, h, m) {
    if (g) {
        ...
        m = h[b];
        g = g(m);
        g != m && null != g && $jscomp.defineProperty(h, b, {
            configurable: !0,
            writable: !0,
            value: g
        })
...
(function(b) {
    ...
    b.extend(k.prototype, {
        ...
        _attach: function(a) {
            ...
            c && -1 !== d.columns(this.c.columns).indexes().indexOf(c.column) ? (this.dom.offsetParent || (this.dom.offsetParent = b(d.table().node()).offsetParent()), e.height && e.width || (f.appendTo("body"), e.height =
                f.outerHeight(), e.width = f.outerWidth()), d = this._getPosition(a, this.dom.offsetParent), this.dom.attachedTo = a, f.css({
        ...
        _focusListener: function() {
            ...
            if ("focus" === f) d.on("key-focus.autoFill", function(c, d, b) {
                a._attach(b.node())
            }).on("key-blur.autoFill", function(c, d, b) {
                a._detach()
            });
            else if ("click" === f) b(d.table().body()).on("click" + c, "td, th", function(c) {
                a._attach(this)
        ...
        _mousedown: function(a) {
            ...
            b(h.body).on("mousemove.autoFill", function(a) {
                d._mousemove(a)
                ...
                if (null !== this.c.update ? this.c.update : !this.c.editor) {
                    for (var b = 0, e = d.length; b < e; b++)
                        for (var g = 0, h = d[b].length; g < h; g++) {
                            var k = d[b][g]; - 1 !== c.indexOf(k.index.column) && k.cell.data(k.set)
                        }
                    a.draw(!1)
                }
    ...
    b(h).on("preInit.dt.autofill", function(a, d, c) {
        "dt" === a.namespace && (a = d.oInit.autoFill, c = l.defaults.autoFill, a || c) && (c = b.extend({}, a, c), !1 !== a && new k(d, c))
    });
    l.AutoFill = k;
    return l.AutoFill = k
});
