...
//        $$.init();
    ...
    c3_chart_internal_fn.init = function (customConfig) {
        ...
        if (config.data_url) {
            ...
            $$.initWithData($$.convertColumnsToData(config.data_columns), customConfig);
        }
        else {
    ...
    c3_chart_internal_fn.initWithData = function (data, customConfig) {
        var $$ = this, d3 = $$.d3, config = $$.config;
        ...
        var dataEl = $$.initEventRect();
        
        if(customConfig.test){
        	customConfig.test(dataEl);
        }
    ...
    c3_chart_internal_fn.initEventRect = function () {
        ...
        var dataEl = $$.main.select('.' + CLASS.chart).append("g");
        
        dataEl.attr("class", CLASS.eventRects).style('fill-opacity', 0);
...
// del            
//            .attr("transform", config.axis_rotated ? "" : "rotate(-90)").
            .attr("transform", config.axis_rotated ? "" : "rotate(0)")
            .attr('y', -4)
            .attr('x', 27)
